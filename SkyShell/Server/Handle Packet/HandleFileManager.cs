...
namespace Server.Handle_Packet
{
    public class HandleFileManager
    {
                    ...
                    case "getPath":
                        {
                            ...
                            if (FM != null)
                            {
                                ...
                                FM.listView1.Items.AddRange(GetFolders(unpack_msgpack, groupFolder).ToArray());
                                FM.listView1.Items.AddRange(GetFiles(unpack_msgpack, groupFile, FM.imageList1).ToArray());
                    ...
                    case "reqUploadFile":
                        {
                            ...
                            if (FD != null)
                            {
                                ...
                                msgpack.ForcePathObject("File").LoadFileAsBytes(FD.FullFileName);
                    ...
                    case "save":
                        {
                            try
                            {
                                ...
                                if (SD != null)
                                {
                                    ...
                                    SaveFileAsync(unpack_msgpack.ForcePathObject("File"), fileFullPath);
                                    SD.Close();
                                }
                            }
                            catch { }
        ...
        private void SaveFileAsync(MsgPack unpack_msgpack, string name)
        {
